...
function customSlick(ele) {
  ...
  $(".slick-prev").html(
    "<svg xmlns='http://www.w3.org/2000/svg' width='15' height='12' viewBox='0 0 6.591 11.061'><path d='M0,10,5,5,0,0' transform='translate(6.061 10.53) rotate(180)' fill='none' stroke='#383838' stroke-width='1.5'></path></svg>"
  )
  $(".slick-next").html(
    '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="12" viewBox="0 0 6.591 11.061"><path d="M0,10,5,5,0,0" transform="translate(0.53 0.53)" fill="none" stroke="#383838" stroke-width="1.5"></path></svg>'
  )
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  closeButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      // Get the parent popup box of the clicked button
      var popupBox = button.closest(".popupBox")

      // Close the parent popup box
      popupBox.style.display = "none" // Or use other methods to hide the popup box
    })
  })
})
